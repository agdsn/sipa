...
project = 'Sipa'
copyright = '2015, Arbeitsgemeinschaft Dresdner Studentennetz (AG DSN), Lukas Juhrich'
author = 'Arbeitsgemeinschaft Dresdner Studentennetz (AG DSN), Lukas Juhrich'
...
latex_documents = [
    (master_doc, 'Sipa.tex', 'Sipa Documentation',
     'Lukas Juhrich et al.', 'manual'),
]
...
man_pages = [
    (master_doc, 'sipa', 'Sipa Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Sipa', 'Sipa Documentation',
     author, 'Sipa', 'One line description of project.',
     'Miscellaneous'),
]
